...
alias gapy="git add package.json 2>/dev/null; git add yarn.lock 2>/dev/null; git add package-lock.json 2>/dev/null"
...
alias g_resethead="git restore --staged"

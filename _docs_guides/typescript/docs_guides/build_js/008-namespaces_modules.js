...
console.log(test_module_1_1.Package.toString());
...
const SetOfExports = require('./testmodules/test-module-1');
...
const testModuleSideEffects = require("testModuleSideEffects");
require('./testmodules/test-module-sideeffects');
...
const test_module_default_exports_1 = require('./testmodules/test-module-default-exports');
console.log(" ----- Can name import from default export whatever your want -----");
console.log(test_module_default_exports_1.default);
console.log('----------------------------------------------------------------------------------');
//#####################################################
...
const theExport = require('./testmodules/test-export-equals');
...
if (conditionToLoad) {
    let benWaBead = require('./testmodules/test-dynamic-module-importing');
...
const testModuleBundle = require("./testmodules/test-module-1");
...
const test_module_1_2 = require("./testmodules/test-module-1");
let zipCodeValidator = new test_module_1_2.ZipCodeValidator();
let someFn = test_module_1_2.myNewFn();
console.log('----------------------------------------------------------------------------------');
//#########################################
//#          RE-EXPORT TO EXTEND          #
//#########################################

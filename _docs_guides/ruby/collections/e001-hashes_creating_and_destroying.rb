...
# LOAD THE TEST FILES
hash_test_file = File.open("#{__dir__}/hash_test.txt", "r")
hash_test_file_2 = File.open("#{__dir__}/hash_test.txt", "r")
...
json_file = File.open("#{__dir__}/commented_json.json").reduce do |output, line|
...
##########################################
puts "***************** DELETING HASH VALUES *****************"
test_hash = {:item1=>"item 1", :item2=>"item 2", :third_item=>"Item number 3"}

puts " ----- CREATE AND DISPLAY HASH TO TEST DELETION -----"
puts test_hash

puts " ----- DELETE ALL HASH VALUES, DISPLAY HASH CONTENT AGAIN (SHOULD BE EMPTY) -----"
test_hash.clear
puts test_hash